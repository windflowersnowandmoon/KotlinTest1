...
import kotlinx.android.synthetic.main.recycleview3_item.view.*
 ...
 *   描   述 :个人信息
 */
class RecycleView3Adapter constructor(context: Context) :
...
//    }
    ...
    override fun onCreateViewHolder(p0: ViewGroup, p1: Int): RecyclerView.ViewHolder {
        var itemView: View =
            LayoutInflater.from(context).inflate(R.layout.recycleview3_item, p0, false)
    ...
    override fun onBindViewHolder(p0: RecyclerView.ViewHolder, p1: Int) {
        p0.itemView.zuoping_img.setImageDrawable(
            ContextCompat.getDrawable(
                context,
                R.mipmap.home_page_no_network2x
            )
        )
    }
